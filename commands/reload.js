...
module.exports = {
    ...
    run: async (client, message, args) => {
        const $o = () => {
            ...
            if (!args[0]) {
                message.channel.send(
                    `Coloque o nome da categoria que deseja carregar`,
                );
            }

            if (!args[1]) {
                message.channel.send(
                    `Coloque o nome do comando que deseja carregar`,
                );
            }
            ...
            try {
                delete require.cache[
                    require.resolve(`../../commands/${categoria}/${comando}.js`)
                ];
                ...
                message.channel.send(
                    `Carreguei o **${comando}** da pasta **${categoria}**`,
                );
            } catch (err) {
